/**
 * Compact, zero-dependency QR Matrix Generator in Pure JavaScript
 * Based on Kazuhiko Arase's QR Code implementation (MIT / Public Domain)
 */
...
QRCodeModel.prototype = {
    addData: function(data) {
        this.dataList.push({
            ...
            data: data,
            getLength: function() { return Buffer.byteLength(data, 'utf8'); },
            write: function(buffer) {
                const b = Buffer.from(data, 'utf8');
                for (let i = 0; i < b.length; i++) buffer.put(b[i], 8);
            }
        });
        this.dataCache = null;
    },
